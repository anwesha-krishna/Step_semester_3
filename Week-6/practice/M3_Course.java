...
// Demonstrates constructor chaining with this(...) so theory-only
// courses don't repeat the same setup logic as lab courses.
...
class Course {
    ...
    // Theory-only courses chain to the 4-argument constructor with labCredits = 0
